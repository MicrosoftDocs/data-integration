...
>[!Important]
> You need to: 
> 1. Be a gateway admin of the VNet data gateway you want to remove
> 2. Have the Azure Network Contributor role in the Azure portal
> 3. Register the Microsoft.PowerPlatform provider as a resource provider
