...
- Power Platform dataflows:
  ...
  - VNet data gateways are created in the region of your virtual network and subnet. There's currently no option to change the VNet data gateway region. VNet data gateways can used in reigons other than the home region of your tenant.
