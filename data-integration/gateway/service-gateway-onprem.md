...
* Users are limited to 1,000 data sources maximum per user on each enterprise or personal gateway. [How to avoid reaching this limit](/service-gateway-onprem-faq#what-do-i-need-to-do-if-i-reach-the-maximum-limit-of-1-000-data-sources-per-user--and-how-do-i-avoid-reaching-this-limit-).
