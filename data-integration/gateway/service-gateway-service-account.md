...
1. On the computer hosting the data gateway, launch the Services applet from Administrative Tools or by pressing Windows-R to launch a **Run** window, and running _services.msc_.
