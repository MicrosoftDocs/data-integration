...
> [!NOTE]
> Gateway diagnostics doesn't capture diagnostics directly related to the (virtual) machine and its network, like bandwidth or latency. Hoewever, these diagnostics might impact your gateway performance. You can use recource monitoring tools to monitor your machine.
