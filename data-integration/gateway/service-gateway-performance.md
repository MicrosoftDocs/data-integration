...
|**EvaluationContext**|Contains the artifactId (that is, DatasetId, DataflowsId) along with additional data depending on the artifact. Note that this field will only populate for Dataflows Gen2 and Power Platform Dataflows.|
