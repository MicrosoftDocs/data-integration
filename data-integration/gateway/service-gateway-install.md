...
* Workloads may have specific requirements around compatible gateway versions. For dataflows, see [using dataflows with on-premises data](/power-query/dataflows/using-dataflows-with-on-premises-data).
