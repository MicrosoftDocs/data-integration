...
* If you use a virtualization layer for your virtual machine, performance might suffer or perform incosistently. We recommend that you set the gateway on a wired device for best network performance.
