...
If you've changed any of these settings, but you now want to use automatic scaling, use the `MashupDisableContainerAutoConfig` setting. In _\Program Files\On-premises data gateway\Microsoft.PowerBI.DataMovement.Pipeline.GatewayCore.dll.config_ set `MashupDisableContainerAutoConfig` to _False_.
