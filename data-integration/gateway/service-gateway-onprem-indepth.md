...
Traffic goes from the gateway to Azure Relay to the Power BI backend cluster. By using express route the users can make sure that this traffic doesn't traverse the public internet. All Azure internal traffic goes over the Azure backbone.
